...
const initialData: Author[] = [
  ...
  },
  {
    ...
    placeOfBirth: "Portland, Maine, The United States",
    genre: "Crime, Horror",
    note: "Stephen Edwin King (born September 21, 1947) is an <strong>American author</strong> of horror, supernatural fiction, suspense, crime, science-fiction, and fantasy novels. Described as the \"King of Horror\", a play on his surname and a reference to his high standing in pop culture,[2] his books have sold more than 350 million copies,[3] and many have been adapted into films, television series, miniseries, and comic books. King has published 63 novels, including seven under the pen name Richard Bachman, and five non-fiction books.[4] He has also written approximately 200 short stories, most of which have been published in book collections.",
    foto: getDefaultAuthorFoto()
  },
];
