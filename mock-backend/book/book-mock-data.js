...
import { getDefaultBookCover, gunslingerCover, king112263cover, mistbornCover1, mistbornCover2, mistbornCover3, shiningCover } from '../author/default-fotos';
import { findUserBookAssignmentsForUser } from '../user/user-book-assignment-mockservice';
export function createOrUpdateBook(newElement) {
...
export function findBooksForUser(username) {
...
export function findBooksOfAuthor(id) {
